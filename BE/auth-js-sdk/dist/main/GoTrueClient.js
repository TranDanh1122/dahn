...
class GoTrueClient {
    ...
    constructor(options) {
        ...
        if ((0, helpers_1.isBrowser)() &&
            ...
            (_b = this.broadcastChannel) === null || _b === void 0 ? void 0 : _b.addEventListener("message", (event) => __awaiter(this, void 0, void 0, function* () {
    ...
    signInAnonymously(credentials) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield (0, fetch_1._request)(this.fetch, "POST", `${this.url}/signup`, {
                ...
                if ("email" in credentials) {
                    ...
                    if (this.flowType === "pkce") {
                        [codeChallenge, codeChallengeMethod] =
                            yield (0, helpers_1.getCodeChallengeAndMethod)(this.storage, this.storageKey);
                    }
     ...
     */
    exchangeCodeForSession(authCode, verificationCode = null) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initializePromise;
            return this._acquireLock(-1, () => __awaiter(this, void 0, void 0, function* () {
                return this._exchangeCodeForSession(authCode, verificationCode);
            }));
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ("message" in credentials) {
                ...
                if ("signIn" in resolvedWallet && resolvedWallet.signIn) {
                    const output = yield resolvedWallet.signIn(Object.assign(Object.assign(Object.assign({ issuedAt: new Date().toISOString() }, options === null || options === void 0 ? void 0 : options.signInWithSolana), { 
            ...
            try {
                const { data, error } = yield (0, fetch_1._request)(this.fetch, "POST", `${this.url}/token?grant_type=web3`, {
                    headers: this.headers,
    ...
    _exchangeCodeForSession(authCode, verificationCode = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const storageItem = yield (0, helpers_1.getItemAsync)(this.storage, `${this.storageKey}-code-verifier`);
            ...
            try {
                const { data, error } = yield (0, fetch_1._request)(this.fetch, "POST", `${this.url}/token?grant_type=pkce`, {
                    ...
                    body: {
                        auth_code: authCode,
                        code_verifier: verificationCode !== null && verificationCode !== void 0 ? verificationCode : codeVerifier,
                    },
                    xform: fetch_1._sessionResponse,
                });
    ...
    signInWithSSO(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let codeChallengeMethod = null;
                if (this.flowType === "pkce") {
                    [codeChallenge, codeChallengeMethod] = yield (0, helpers_1.getCodeChallengeAndMethod)(this.storage, this.storageKey);
                }
                return yield (0, fetch_1._request)(this.fetch, "POST", `${this.url}/sso`, {
                    body: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, ("providerId" in params
                        ? { provider_id: params.providerId }
                        : null)), ("domain" in params ? { domain: params.domain } : null)), { redirect_to: (_b = (_a = params.options) === null || _a === void 0 ? void 0 : _a.redirectTo) !== null && _b !== void 0 ? _b : undefined }), (((_c = params === null || params === void 0 ? void 0 : params.options) === null || _c === void 0 ? void 0 : _c.captchaToken)
                        ? {
                            gotrue_meta_security: {
    ...
    getSession() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initializePromise;
            const result = yield this._acquireLock(-1, () => __awaiter(this, void 0, void 0, function* () {
    ...
    resetPasswordForEmail(email, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let codeChallengeMethod = null;
            if (this.flowType === "pkce") {
                [codeChallenge, codeChallengeMethod] = yield (0, helpers_1.getCodeChallengeAndMethod)(this.storage, this.storageKey, true // isPasswordRecovery
                );
            }
            try {
    ...
    _recoverAndRefresh() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const expiresWithMargin = ((_a = currentSession.expires_at) !== null && _a !== void 0 ? _a : Infinity) * 1000 - Date.now() <
                    ...
                    try {
                        ...
                        try {
                            return yield this._useSession((result) => __awaiter(this, void 0, void 0, function* () {
                                ...
                                const expiresInTicks = Math.floor((session.expires_at * 1000 - now) /
                                    constants_1.AUTO_REFRESH_TICK_DURATION_MS);
    ...
    fetchJwk(kid, jwks = { keys: [] }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data, error } = yield (0, fetch_1._request)(this.fetch, "GET", `${this.url}/.well-known/jwks.json`, {
                headers: this.headers,
            });
            if (error) {
                throw error;
    ...
    getClaims(jwt, jwks = { keys: [] }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const isValid = yield crypto.subtle.verify(algorithm, publicKey, signature, (0, base64url_1.stringToUint8Array)(`${rawHeader}.${rawPayload}`));
                if (!isValid) {
