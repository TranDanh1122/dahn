    ...
    return <>
        ...
        <div className="flex items-center gap-3">
            <fieldset className="flex w-1/2 flex-col gap-2">
                <label htmlFor="environment" className="text-neutral-600 font-light">Status</label>
                <Select<EnumSelectType[number]>
                    id="environment" hasIcon
                    className="flex-grow-0 border border-neutral-300 hover:border-blue-300 rounded-lg "
                    changeValue="value"
                    valueKey="value"
                    textKey="text"
