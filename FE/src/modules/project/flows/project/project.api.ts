...
export const updateEnvAPI = async (projectId: string, data: EnvData, envId?: string) => await AxiosClient.put(`${API_ENDPOINT.project}/${projectId}/environment/${envId}`, { json: data, credentials: "include" })