...
export const postWorkspaceAPI = async (data: FormData) => AxiosClient.post(API_ENDPOINT.workspace, data, { withCredentials: true })
...
export const putWorkspaceByIDAPI = async (id: string, data: FormData) => AxiosClient.put(`${API_ENDPOINT.workspace}/${id}`, data, { withCredentials: true })