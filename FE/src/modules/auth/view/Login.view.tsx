    ...
    return <>
        <AuthForm onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <p className="text-sm flex justify-between w-full">
                ...
                <Link to="/auth/forgot-password" className="text-blue-600 underline text-base font-semibold w-max"> {t('label.forgot_link')} </Link></p>
            ...
            <p className="text-center text-sm space-y-1 font-semibold">
                ...
                <Link role="link" aria-label="Go to register" to="/auth/register" className="text-blue-600 w-full block underline text-base font-semibold"> {t('label.register_link')}</Link>
            </p>
